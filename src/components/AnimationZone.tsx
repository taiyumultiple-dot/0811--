// -*- 動畫專區 -*-
// 原本掛在「拼音學習」頁的第二個分頁，2026-08-18 移到「課堂小工具」底下變成一項工具，
// 頂部導覽列不再單獨佔一格。內容本身沒動，只是整包搬成獨立元件。
import { useState, useEffect } from 'react';
import { ExternalLink, Play, Share2, Tv } from 'lucide-react';
...
export default function AnimationZone() {
